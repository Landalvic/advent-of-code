...
public class Case implements Comparable<Case> {
	...
	public boolean isInsectePrec() {
		return insectePrec;
	}

	public void setInsectePrec(boolean insectePrec) {
		this.insectePrec = insectePrec;
	}

	public void propagation() {
		int nbrInsecte = 0;
		for (Case case1 : casesAdjacentes) {
			if (case1.insectePrec) {
				nbrInsecte++;
			}
		}
		if (insectePrec) {
			...
			if (nbrInsecte == 1 || nbrInsecte == 2) {
				insecte = true;
			}
		}
	}

	public boolean isInsecte() {
		return insecte;
	}

	public void setInsecte(boolean insecte) {

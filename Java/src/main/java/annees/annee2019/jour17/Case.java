...
public class Case implements Comparable<Case> {
	...
	public int nbrAlignement() {
		if (echafaudage && nord != null && nord.isEchafaudage() && sud != null && sud.isEchafaudage() && est != null
				&& est.isEchafaudage() && ouest != null && ouest.isEchafaudage()) {
	...
	public boolean isEchafaudage() {
		return echafaudage;
	}

	public void setEchafaudage(boolean echafaudage) {

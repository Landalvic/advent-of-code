...
public class Annee2019Jour15Exercice1 extends Exercice {

	public static void main(String[] args) {
		new Annee2019Jour15Exercice1().lancer("src/main/resources/annee2019/jour15/data.txt");
	}
	...
	public String run(String input) throws AdventOfCodeException {
		...
		return "" + depart.deplacement(arrivee).size();
	}

...
public class Annee2019Jour14Exercice3 extends Exercice {

	protected static final Pattern pattern = Pattern.compile("<x=(.*), y=(.*), z=(.*)>");

	public static void main(String[] args) {
		new Annee2019Jour14Exercice3().lancer("src/main/resources/annee2019/jour14/data.txt");
	}
	...
	private void approche(long ores, long quantiteDepart, int tailleE, List<Reaction> reactions) {
		int multiplicateur = (int) ((ores / quantiteDepart) * 0.50);
		long nbrOre = quantiteDepart * multiplicateur;
		long fois = multiplicateur * tailleE;
		while (nbrOre < ores) {
			long r = (long) calculer(reactions, null, "FUEL");
			nbrOre += r;
			fois++;
		}
	}

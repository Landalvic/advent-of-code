...
public class Annee2020Jour18Exercice2 extends Annee2020Jour18 {

	public static void main(String[] args) {
		new Annee2020Jour18Exercice2().lancer(true);
	}

	public Annee2020Jour18Exercice2() {
		super(2);
	}
	...
	public String run(String input) throws AdventOfCodeException {
		...
		Calculatrice calculatrice = new Calculatrice(Arrays.asList(new OperateurAddition(2), new OperateurMultiplication(1)));

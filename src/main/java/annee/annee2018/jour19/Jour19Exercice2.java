package annee.annee2018.jour19;
...
public class Jour19Exercice2 {
	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			instructionPointer++;
			System.out.println(Arrays.toString(registres) + " - " + instructionPointer + " - " + list.size());
			list.add((int) registres[5]);
		}
